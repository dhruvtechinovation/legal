...
//       if (currentQuestion.isConsentStep) {
//         console.log("data from if" , userData)
//         const { category, issue, location, name, phone } =userData
...
//                 {item.type === "options" && (
//                   <Picker
//                     selectedValue={userData.category} // Assuming userData.category stores the selected value
...
//                       <TouchableOpacity style={styles.consentButton} onPress={() => handleConsent(true)}>
//                         <Text style={styles.optionText}>I Consent</Text>
//                       </TouchableOpacity>
//                       <TouchableOpacity style={[styles.consentButton, { backgroundColor: "#EF4444" }]} onPress={() => handleConsent(false)}>
...
//                 />
//                 <Text style={styles.wordCount}>{inputText.trim().split(/\s+/).length}/100</Text>
